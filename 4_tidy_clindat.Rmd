...
```{r}
clinDataFn <- "./input/datasets/CRLM_clinData.xlsx"
clinDataFn2 <- "./input/datasets/CRLM_clinData2.xlsx"
patDataFn1 <- "./input/datasets/CRLM_pathData.xlsx"
patDataFn2 <- "./input/datasets/CRLM_pathData2.xlsx"
...
clinData2 <- read_excel(clinDataFn2, col_types = c("numeric", "text", "numeric", "numeric", "numeric", "text", "text", "numeric", "text", "numeric", "numeric", "numeric", "text"))
...
clinData2 <- rename(clinData2,  
                   ...
                   pt_radical_resection = "Radical resection of primary tumour, Y/N", 
